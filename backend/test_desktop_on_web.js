...
async function test() {
  try {
    ...
    // Desktop app configuration but sent to edit-api-sg.capcut.com!
    const device = {
      aid: "359289", // Desktop App ID
      app_name: "CapCut",
      appvr: "8.7.0",
    ...
    const url = `https://edit-api-sg.capcut.com/lv/v1/common_task/new?${new URLSearchParams(queryParams).toString()}`;
    ...
    console.log('Sending desktop payload to edit-api-sg.capcut.com/lv/v1/common_task/new...');
