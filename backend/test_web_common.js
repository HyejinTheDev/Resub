...
async function test() {
  try {
    ...
    const device = {
      ...
      device_id: "7655937363961415189",
      iid: "",
      region: "VN",
      loc: "VN",
      lan: "vi-VN",
      pf: "7",
      tdid: "7655937363961415189", // Try set tdid same as device_id!
    };
    ...
    const url = "https://edit-api-sg.capcut.com/lv/v1/common_task/new";
    const now = Math.floor(Date.now() / 1000);

    const pathPart = "ask/new";
    const signStr = `9e2c|${pathPart}|7|${device.appvr}|${now}|${device.tdid}|11ac`;
    ...
    console.log('Sending request to edit-api-sg.capcut.com/lv/v1/common_task/new with tdid set...');
